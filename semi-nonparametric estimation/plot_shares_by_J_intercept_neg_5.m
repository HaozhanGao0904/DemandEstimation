...
t = tiledlayout(2,2);
hist_J1 = nexttile;
histogram(share_in_true{1,1},'Normalization','probability','BinWidth',.005);
title('J=3')

hist_J2 = nexttile;
histogram(share_in_true{1,2},'Normalization','probability','BinWidth',.005);
title('J=5')

hist_J3 = nexttile;
histogram(share_in_true{1,3},'Normalization','probability','BinWidth',.005);
title('J=10')

hist_J4 = nexttile;
histogram(share_in_true{1,4},'Normalization','probability','BinWidth',.005);
title('J=20')
